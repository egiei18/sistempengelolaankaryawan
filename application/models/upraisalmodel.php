...
class Upraisalmodel extends CI_Model {
	...
	function GetNilai() {
        return $this->db->get('tabel_upraisal')->result();
    }
    ...
    function GetData($id) {
    	...
    	$id = $this->uri->segment(3);
    	return $this->db->get_where('tabel_upraisal', array('id'=> $id))->row();
    }
	...
	public function delete($param) {
		return $this->db->delete('tabel_upraisal', array('id' => $param));
	}
